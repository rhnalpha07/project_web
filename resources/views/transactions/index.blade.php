...
<div class="bg-gray-900 text-gray-100 min-h-screen py-8">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-10">
            <h1 class="text-4xl font-bold text-amber-500 mb-3">My Transactions</h1>
            <p class="text-xl text-gray-400">View your purchase history</p>
        </div>
        ...
        <div class="bg-gray-800 rounded-lg p-8 text-center">
            ...
            <h3 class="text-xl font-bold text-gray-300 mb-2">No Transactions Yet</h3>
            <p class="text-gray-400 mb-4">Start exploring our collection and make your first purchase!</p>
                ...
                <table class="min-w-full divide-y divide-gray-700">
                    ...
                    <tbody class="bg-gray-800 divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-amber-500 font-medium">${{ number_format($transaction->amount, 2) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('transactions.show', $transaction) }}" class="text-amber-500 hover:text-amber-600">View Details</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
