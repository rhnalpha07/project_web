            ...
            <form action="{{ route('admin.books.update', $book) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                id="price" name="price" value="{{ old('price', $book->price) }}" min="0" step="0.01" required>
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('publication_date') is-invalid @enderror" 
                                id="publication_date" name="publication_date" value="{{ old('publication_date', $book->publication_date->format('Y-m-d')) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('language') is-invalid @enderror" 
                                id="language" name="language" value="{{ old('language', $book->language) }}" required>
                            @error('language')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3">
                            <div id="currentImageContainer" class="mb-3 text-center {{ $book->cover_image ? '' : 'd-none' }}">
                                <p>Current Image:</p>
                                @if($book->cover_image)
...
<script>
    ...
    $(document).ready(function() {
        ...
        @if($errors->any())
            let oldCategories = {!! json_encode(old('categories', $book->categories->pluck('id')->toArray())) !!};
            $('#categories').val(oldCategories).trigger('change');
            
            let oldGenres = {!! json_encode(old('genres', $book->genres->pluck('id')->toArray())) !!};
